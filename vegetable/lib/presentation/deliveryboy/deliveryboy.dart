...
class Deliveryboy extends StatefulWidget {
  ...
  @override
  State<Deliveryboy> createState() => _FarmersignupState();
}

class _FarmersignupState extends State<Deliveryboy> {
  Auth _auth = Auth.signup;
  final _signUpFormKey = GlobalKey<FormState>();
  final _signInFormKey = GlobalKey<FormState>();
  final DeliveryService authService = DeliveryService();
  ...
  TextEditingController vechicleController = TextEditingController();
  ...
  void dispose() {
    ...
    vechicleController.dispose();
  }

  void signUpUsertwo() {
    authService.signUpUsertwo(
      context: context,
      ...
      vechicle: vechicleController.text,
    );
  }

  void signInUsertwo() {
    authService.signInUsertwo(
      context: context,
      email: _emailController.text,
      password: _passwordController.text,
    );
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: (val) {
                              if (val!.isEmpty) {
                                return "please enter the vechicle number";
                              }
                              return null;
                            },
                            maxLines: 1,
